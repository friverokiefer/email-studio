...
/** === COMPONENTE PRINCIPAL DEL WORKSPACE (SOLO EDITOR) === */
export function Email2Workspace({
  ...
  onImagesChange?: (images: EmailV2Image[]) => void;
}) {
  ...
  // Sincronizar selección de imagen
  useEffect(() => {
    ...
    <div className="flex h-full min-h-0 w-full flex-col bg-white">
      ...
      <div className="flex-1 overflow-y-auto">
        <div className="mx-auto flex w-full max-w-[840px] flex-col px-3 lg:px-3.5 py-2 lg:py-3.5">
                ...
                <div className="flex items-center px-1">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-[9px] text-slate-500">
                        Añade assets finales externos. Se guardan en el batch.
                      </p>
                    </div>
                  </div>
                </div>
          ...
          {/* MOBILE PREVIEW (Solo visible en pantallas pequeñas) */}
